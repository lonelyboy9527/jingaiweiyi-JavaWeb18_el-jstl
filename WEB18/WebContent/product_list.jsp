...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${productList }" var="product">
			...
			<a href="${pageContext.request.contextPath }/product_info.jsp"> <img src="${pageContext.request.contextPath }/${product.pimage }"
				width="170" height="170" style="display: inline-block;">
			</a>
			<p>
				<a href="${pageContext.request.contextPath }/product_info.jsp" style='color: green'>${product.pname }</a>
			</p>
			<p>
